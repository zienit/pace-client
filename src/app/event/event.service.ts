...
export class EventService {
    ...
    private grandsPrix: GrandPrix[] = [{
        ...
        id: '32ff9147', name: 'Chinese GP', country: 'chn', timezone: 'asia/shanghai', sessions: [
        ...
        id: '199c429f', name: 'Azerbaijan GP', country: 'aze', timezone: 'asia/baku', sessions: [
        ...
        id: 'da25e95c', name: 'Spanish GP', country: 'esp', timezone: 'europe/madrid', sessions: [
    ...
    getGrandPrix(id: string): GrandPrix {
        return this.grandsPrix.find(gp => gp.id === id);
    }
}